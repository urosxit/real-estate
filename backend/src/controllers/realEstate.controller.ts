...
export class RealEstateController {
    topFiveRealEstates = (req: express.Request, res: express.Response) => {
    ...
    getRealEstateById = (req: express.Request, res: express.Response) => {
        RealEstate.find({
            'id': req.body.id
        }, (err, realEstates) => {
            if (err) {
    ...
    getFilteredRealEstates = (req: express.Request, res: express.Response) => {
        RealEstate.find({
    ...
    getRealEstatesFromAdvertiser = (req: express.Request, res: express.Response) => {
        RealEstate.find({
    ...
    markEstateAsSold = (req: express.Request, res: express.Response) => {
        RealEstate.updateOne({ 'id': req.body.id }, { $set: { 'sold': true } },
            (err, realEstate) => {
                if (err) {
                    console.log(err);
                }
    ...
    addNewRealEstate = (req: express.Request, res: express.Response) => {
        let fullLocation = {
    ...
    updateAveragePrice = (req: express.Request, res: express.Response) => {
        RealEstate.updateMany({ 'id': { $in: req.body.ids } }, { $set: { 'averagePrice': req.body.averagePrice } },
            (err, realEstates) => {
                if (err) {
                    console.log(err);
                }
